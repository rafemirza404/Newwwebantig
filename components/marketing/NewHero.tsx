    ...
    <section className="bg-[#EEF4FF] py-24 md:py-36">
      <div className="container mx-auto px-4 max-w-5xl flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black leading-tight animate-slide-up mb-6">
          Automation Strategy That Fixes Revenue Leaks, For Operations-Heavy
          Businesses
        </h1>

        {/* Subheading */}
        <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-2xl mx-auto animate-fade-in mb-10">
          Audit your operations. Identify the leaks. Automate the fix. First
          call in 30 mins. Revenue flowing in 90 days.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-4 animate-fade-in">
          <Button
            ...
            className="bg-[#4F7CFF] hover:bg-[#4F7CFF]/90 text-white text-lg font-semibold px-8 py-7 rounded-full transition-all duration-300 hover:scale-105 shadow-[0_0_30px_rgba(79,124,255,0.4)] hover:shadow-[0_0_40px_rgba(79,124,255,0.6)]"
          >
