    ...
    children: [
      {
        ...
        desc: "Self-serve operations audit",
      },
      {
        label: "For Agencies",
        href: "/solutions/agencies",
        desc: "Audit clients at scale",
      },
      {
        label: "For Consultants",
        href: "/solutions/consultants",
        desc: "Add AI services to your stack",
      },
    ],
  },
  {
    ...
    children: [
      { label: "Blog", href: "/blog", desc: "Insights & guides" },
      {
        label: "How It Works",
        href: "/how-it-works",
        desc: "See the audit in action",
      },
      {
        label: "Sample Report",
        href: "/sample-report",
        desc: "Preview a real AI audit",
      },
    ],
  },
  {
    ...
    >
      <div className="m-container flex items-center justify-between h-16">
        ...
        >
          ...
          />
          <span className="text-[21px] leading-[1.15] font-normal tracking-[-0.03em] text-white">
            AgentBlue
          </span>
        </Link>
              ...
              >
                ...
                {openDropdown === link.label && (
                  <div className="absolute top-full left-1/2 -translate-x-1/2 pt-2 w-[280px]">
                    <div className="rounded-xl bg-[#0c0c0c] border border-white/[0.06] backdrop-blur-xl p-2 shadow-2xl shadow-black/40">
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <Link
            href="/signup"
            className="bg-white text-black font-semibold px-5 py-2 rounded-full no-underline text-[13px] hover:bg-white/90 transition-all"
          >
            Start Free Trial
          </Link>
        </div>
        ...
        <div className="lg:hidden border-t border-white/[0.06] bg-[#0c0c0c]">
          <div className="p-4 space-y-1">
            ...
            <div className="pt-3 border-t border-white/[0.06]">
              <Link
                href="/signup"
                className="m-btn-primary w-full text-center no-underline"
              >
                Start Free Trial
              </Link>
            </div>
