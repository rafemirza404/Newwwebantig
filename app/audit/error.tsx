    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-6">
            <div className="w-full max-w-md bg-card border-none shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] rounded-3xl p-10 text-center">
                ...
                <h2 className="text-foreground text-xl font-bold mb-2">Audit Error</h2>
                <p className="text-muted-foreground text-[15px] mb-8">
                    Something went wrong during the audit. Your previous answers are saved — you can try again.
                </p>
